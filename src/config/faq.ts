...
export const FAQ_ITEMS: { question: string; answer: string }[] = [
  ...
  {
    question: "AI로 모의고사를 만들 수 있나요?",
    answer:
      "네, 과목과 난이도를 선택하면 AI가 실전과 비슷한 모의고사를 생성합니다. OMR 답안지와 타이머로 풀고 자동 채점·해설까지 받을 수 있습니다.",
  },
  {
    question: "오답노트는 어떻게 사용하나요?",
    answer:
      "틀린 문제는 자동으로 오답노트에 기록됩니다. 오답 DNA 분석으로 반복되는 실수 패턴을 확인하고, 간격 반복 복습으로 취약한 문제를 다시 풀어볼 수 있습니다.",
  },
  {
    question: "어떤 과목을 지원하나요?",
    answer: "수학·영어·국어·과학을 기본으로 제공하며, 원하는 과목을 자유롭게 추가할 수 있습니다.",
  },
];
